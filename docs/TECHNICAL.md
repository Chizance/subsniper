# SubSniper - technical notes

Engineer-facing documentation: architecture, measurements, and design rationale.
**If you just want to install and use SubSniper, read the [README](../README.md)
instead** - it's written for people who don't work with code.
